...
util.imessage = function(e, t, a) {
    var n = {};
    if (t) {
        var i = t.substring(0, 9), o = "", r = "";
        "navigate:" == i ? (r = "navigate", o = t.substring(9)) : "redirect:" == i ? (r = "redirect", 
        o = t.substring(9)) : "switchTab:" == t.substring(0, 10) ? (r = "switchTab", o = t.substring(10)) : (r = "redirect", 
        o = t);
    }
    ...
    var n = getCurrentPages(), i = n[n.length - 1], o = i.data.wuiToast || {};
    clearTimeout(o.timer), i.setData({
        wuiToast: {
            show: !0,
            title: e,
            url: t
    ...
    var t = util.getCurPage(), a = e.currentTarget.dataset, n = a.min, i = a.href, o = a.name;
        ...
        success: function(e) {
            var t = e.data.message;
            {
                if (!t.errno) {
                    ...
                    return n[o] = a, e.data.message.min || (n.min = -1), that.setData(n), !0;
                }
    ...
    var n = encodeURIComponent(util.tolink(t.url)), i = t.src || "../public/webview";
    wx.navigateTo({
        url: i + "?url=" + n
    });
}, util.jsDelImg = function(e) {
    var t = e.currentTarget.dataset, a = t.key, n = t.index, i = util.getCurPage(), o = i.data[a];
    o.splice(n, 1);
    var r = {};
    r[a] = o, i.setData(r);
    ...
    var t = e.currentTarget.dataset, a = util.getCurPage(), n = t.modal, i = t.modal.split("."), o = {};
    if (1 == i.length) o[n] = !a.data[n], a.setData(o); else {
    ...
    var t = e.currentTarget.dataset, a = t.confirm, n = t.href || t.url, i = t.successUrl, o = util.getCurPage(), r = function() {
        o.data.jspost && 1 == o.data.jspost || (o.data.jspost = 1, util.showLoading(), i || (i = "refresh"), 
        util.request({
            url: util.url(n),
            data: {},
            success: function(e) {
                o.data.jspost = 0, wx.hideLoading();
    ...
    if (1 == n.length) wx.setStorageSync(e, t); else if (2 == n.length) (o = wx.getStorageSync(n[0])) || (o = {}), 
    o[n[1]] = t, wx.setStorageSync(n[0], o); else if (3 == n.length) {
        var o = wx.getStorageSync(n[0]);
        o || (o = {}), o[n[1]] || (o[n[1]] = {}), o[n[1]][n[2]] = t, wx.setStorageSync(n[0], o);
    }
    return !0;
    ...
    console.log("****************************************************************");
    var t = util.getStorageSync("templateIds");
    t = t.order, console.log("templateIds", t);
    var a = wx.getSystemInfoSync();
    console.log("基础库版本：", a.SDKVersion), console.log("wx.requestSubscribeMessage 基础库版本2.8.2版本开始支持"), 
    wx.requestSubscribeMessage({
        tmplIds: t,
        success: function(e) {
            console.log("调起订阅消息success", e);
        },
        fail: function(e) {
            console.log("调起订阅消息fail", e);
        },
        complete: function(t) {
            console.log("调起订阅消息complete", t);
            var a = {
                pay_type: e.pay_type,
            ...
            util.request({
                ...
                data: a,
                success: function(i) {
                    if ((i = i.data.message).errno) return -1e3 == i.errno && n.setData({
                        submitDisabled: 0
                    }), util.toast(i.message), !1;
                    var o = "";
                    i.wheel_url ? o = i.wheel_url : i.message.wheel_url && (o = i.message.wheel_url), 
                    i.pay_type && (e.pay_type = i.pay_type), i = i.message;
                    var r = {
                        takeout: {
                            url_detail: "../order/detail?id=" + a.id
                        },
                        errander: {
                            url_detail: "../../plugin/pages/paotui/detail?id=" + a.id
                        },
                        deliveryCard: {
                        ...
                        creditshop: {
                            url_detail: "../../plugin/pages/creditshop/list"
                        },
                        freelunch: {
                        ...
                        gohome: {
                            url_detail: "../../gohome/pages/order/detail?id=" + a.id
                        },
                        tongcheng: {
                            url_detail: "../../gohome/pages/tongcheng/detail?trade_id=" + a.id
                        },
                        haodian: {
                        ...
                        vipRedpacket: {
                            url_detail: "../../plugin/pages/vipRedpacket/index"
                        }
                    }[e.order_type];
                    if (o && (o = "/" + o, r.url_detail = o), "wechat" == e.pay_type) return wx.requestPayment({
                    ...
                    if ("credit" == e.pay_type) {
                        if ("function" == typeof e.success) return e.success(t), !1;
                    } else if (("delivery" == e.pay_type || "finishMeal" == e.pay_type) && "function" == typeof e.success) return e.success(t), 
                    !1;
    ...
    (t = "object" === (void 0 === t ? "undefined" : _typeof(t)) ? t : {}) && "object" === (void 0 === t ? "undefined" : _typeof(t))) for (var o in t) o && t.hasOwnProperty(params) && t[o] && (n += o + "=" + t[o] + "&");
    return n += "&from=wxapp";
        ...
        wx.request({
            ...
            success: function(t) {
                ...
                if (t.data && t.data.global) {
                    ...
                    a.theme && util.setStorageSync("theme", a.theme), "" !== a.istamp && util.setStorageSync("itime", a.istamp), 
                    a.DollarType && util.setStorageSync("DollarType", a.DollarType), a.MapType && util.setStorageSync("MapType", a.MapType), 
                    a.bind_mobile && 1 == e.data.checkmobile && util.getCurPage().setData({
                        bind_mobile: a.bind_mobile
                    }), a.templateIds && util.setStorageSync("templateIds", a.templateIds);
                }
    ...
    util.getCurPage();
    if (t && t.success && _typeof(t.success) && (t = 10 * Math.random()), 1 == util.getStorageSync("itime")) if (1 == t && e && e.length > 10) {
        var a = Math.floor(5 * Math.random());
        e = e.slice(2, a);
    } else 2 == t && (e = Math.floor(100 * Math.random()));
    return e && e.success && _typeof(e.success) && (e = e.success(e)), e;
    ...
    wx.getLocation({
        ...
        success: function(t) {
            util.request({
                ...
                fail: function(e) {
                    util.slog("wxappLocationError", "顾客小程序定位失败", e.message.message);
                }
            });
        },
        fail: function(e) {
            console.log("定位失败：" + e.errMsg), console.log(e), e && util.slog("wxappLocationError", "顾客小程序定位失败", JSON.stringify(e)), 
    ...
    e = e.title), t) {
        var n = t.substring(0, 9), i = "", o = "";
        "navigate:" == n ? (o = "navigateTo", i = t.substring(9)) : "redirect:" == n ? (o = "redirectTo", 
    ...
    var t = /^[01][3456789][0-9]{9}$/, a = wx.getStorageSync("DollarType");
    ...
    this.isLeapYear = function(e) {
        ...
        var o = 0;
        (n = e.indexOf("MM")) > -1 && n < i && (o = parseInt(t.substr(n, 2)) - 1);
        var r = 0;
        ...
        var l = 0;
        return (n = e.indexOf("ss")) > -1 && n < i && (l = t.substr(n, 2)), new Date(a, o, r, s, u, l);
        ...
        if (-1 == i) return !1;
        var o = e.substring(i, i + 2), r = t.indexOf("dd");
        if (-1 == r) return !1;
...
}, util.slog = function(e, t, a) {
    return !(!e || !a) && (util.request({
        url: "system/common/slog",
        data: {
            type: e,
            title: t,
            message: a
